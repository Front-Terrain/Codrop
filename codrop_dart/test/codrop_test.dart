...
void main() {
  group('Codrop Engine Tests', () {
    ...
    test('compressImage compresses PNG image to WebP and JPEG', () {
      ...
      final webp = Codrop.compressImage(samplePng, format: CodropImageFormat.webp);
      expect(webp.isNotEmpty, isTrue);
      expect(webp.sublist(0, 4), equals(utf8.encode('RIFF')));

      final jpeg = Codrop.compressImage(samplePng, format: CodropImageFormat.jpeg);
      expect(jpeg.isNotEmpty, isTrue);
